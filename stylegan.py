...
# Divide the input in groups of 4 and calculate std of each group and then return the average std of the entire input tensor
...
plot_images(images, 5) # 5 is the log2(resolution)
